...
round(fc, 3)
#>          10%    50%   90%
#> h = 1 -1.125 -0.006 1.170
#> h = 2 -1.192 -0.003 1.185
#> h = 3 -1.182 -0.019 1.205
#> h = 4 -1.178  0.001 1.189
#> h = 5 -1.230 -0.042 1.186
#> h = 6 -1.200  0.015 1.184
#> h = 7 -1.223 -0.025 1.200
#> h = 8 -1.195 -0.021 1.210
```
